...
namespace LukeHagar.PlexAPI.SDK.Models.Requests
{
    ...
    public static class ListDownloadQueueItemsStatusExtension
    {
        public static string Value(this ListDownloadQueueItemsStatus value)
        {
            return ((JsonPropertyAttribute)value.GetType().GetMember(value.ToString())[0].GetCustomAttributes(typeof(JsonPropertyAttribute), false)[0]).PropertyName ?? value.ToString();
        }

        public static ListDownloadQueueItemsStatus ToEnum(this string value)
        {
            foreach(var field in typeof(ListDownloadQueueItemsStatus).GetFields())
            {
                ...
                if (attribute != null && attribute.PropertyName == value)
                {
                    ...
                    if (enumVal is ListDownloadQueueItemsStatus)
                    {
                        return (ListDownloadQueueItemsStatus)enumVal;
                    }
                }
            }
