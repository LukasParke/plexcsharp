...
namespace LukeHagar.PlexAPI.SDK.Models.Requests
{
    ...
    public static class StartTranscodeSessionQueryParamSubtitlesExtension
    {
        public static string Value(this StartTranscodeSessionQueryParamSubtitles value)
        {
            return ((JsonPropertyAttribute)value.GetType().GetMember(value.ToString())[0].GetCustomAttributes(typeof(JsonPropertyAttribute), false)[0]).PropertyName ?? value.ToString();
        }

        public static StartTranscodeSessionQueryParamSubtitles ToEnum(this string value)
        {
            foreach(var field in typeof(StartTranscodeSessionQueryParamSubtitles).GetFields())
            {
                ...
                if (attribute != null && attribute.PropertyName == value)
                {
                    ...
                    if (enumVal is StartTranscodeSessionQueryParamSubtitles)
                    {
                        return (StartTranscodeSessionQueryParamSubtitles)enumVal;
                    }
                }
            }
