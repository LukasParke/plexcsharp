...
namespace LukeHagar.PlexAPI.SDK.Models.Requests
{
    ...
    public class GetStreamLoudnessRequest
    {
        /// <summary>
        ...
        public long StreamId { get; set; } = default!;

        /// <summary>
        /// Subsample result down to return only the provided number of samples.
        /// </summary>
        [SpeakeasyMetadata("queryParam:style=form,explode=true,name=subsample")]
        public long? Subsample { get; set; }
    }
}