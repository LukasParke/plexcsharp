...
namespace LukeHagar.PlexAPI.SDK.Models.Requests
{
    ...
    public class SetChannelmapRequest
    {
        ...
        /// </summary>
        [SpeakeasyMetadata("queryParam:style=deepObject,explode=true,name=channelMapping")]
        public Models.Requests.ChannelMapping? ChannelMapping { get; set; }

        /// <summary>
        /// The mapping of changes, passed as a map of device channel to lineup key.
        /// </summary>
        [SpeakeasyMetadata("queryParam:style=deepObject,explode=true,name=channelMappingByKey")]
        public ChannelMappingByKey? ChannelMappingByKey { get; set; }

        /// <summary>
        /// The channels which are enabled.
        /// </summary>
        [SpeakeasyMetadata("queryParam:style=form,explode=true,name=channelsEnabled")]
