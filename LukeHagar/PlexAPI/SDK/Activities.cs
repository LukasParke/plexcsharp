...
namespace LukeHagar.PlexAPI.SDK
{
    ...
    public interface IActivities
    {
        ...
        public  Task<ListActivitiesResponse> ListActivitiesAsync(RetryConfig? retryConfig = null);
        ...
        /// <exception cref="HttpRequestException">The HTTP request failed due to network issues.</exception>
        /// <exception cref="SDKException">Default API Exception. Thrown when the API returns a 4XX or 5XX response.</exception>
        public  Task<CancelActivityResponse> CancelActivityAsync(
    ...
    public class Activities: IActivities
    {
        ...
        /// <exception cref="Error">Unauthorized - Authentication token is missing or invalid. Thrown when the API returns a 401 response.</exception>
        /// <exception cref="SDKException">Default API Exception. Thrown when the API returns a 4XX or 5XX response.</exception>
        public async  Task<ListActivitiesResponse> ListActivitiesAsync(RetryConfig? retryConfig = null)
        {
        ...
        /// <exception cref="HttpRequestException">The HTTP request failed due to network issues.</exception>
        /// <exception cref="SDKException">Default API Exception. Thrown when the API returns a 4XX or 5XX response.</exception>
        public async  Task<CancelActivityResponse> CancelActivityAsync(
            CancelActivityRequest request,
            RetryConfig? retryConfig = null
        )
        {
